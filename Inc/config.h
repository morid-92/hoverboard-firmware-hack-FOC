...
#define BAT_CALIB_REAL_VOLTAGE  3780      // input voltage measured by multimeter (multiplied by 100). In this case 43.00 V * 100 = 4300
#define BAT_CALIB_ADC           1630      // adc-value measured by mainboard (value nr 5 on UART debug output)
...
// ########################### UART SETIINGS ############################
  ...
  #define SERIAL_TIMEOUT          220                     // [-] Serial timeout duration for the received data. 160 ~= 0.8 sec. Calculation: 0.8 sec / 0.005 sec
#endif
#if defined(FEEDBACK_SERIAL_USART2) || defined(CONTROL_SERIAL_USART2) || defined(DEBUG_SERIAL_USART2) || defined(SIDEBOARD_SERIAL_USART2)
  #ifndef USART2_BAUD
